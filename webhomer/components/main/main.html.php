...
<?php endif; ?>			                    
			    <a href='javascript:new function(){var c=document.cookie.split(";");for(var i=0;i<c.length;i++){var e=c[i].indexOf("=");var n=e>-1?c[i].substr(0,e):c[i];document.cookie=n+"=;expires=Thu, 01 Jan 1970 00:00:00 GMT";}}();window.location = "homer.php";'><li class="ui-state-default ui-corner-all" title="Clear UI / Cookies"><span class="ui-icon ui-icon-trash"></span></li></a>
                            </ul>
			<div class="right"></div> 
		</div> 
	</div> 
