...
function showMessage(id,table,tnode,location) {
...
function showCallFlow(id,table,tnode,location,unique, tag) {

  var url = "homer.php?task=showcallflow&id="+id+"&table="+table+"&tnode="+tnode+"&unique="+unique+"&location="+location+"&tag="+tag;
  newwindow = window.open(url,'callFlow','toolbar=yes,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=700,screenX=200,screenY=200,top=50,left=150')
  if (window.focus) {newwindow.focus()}
